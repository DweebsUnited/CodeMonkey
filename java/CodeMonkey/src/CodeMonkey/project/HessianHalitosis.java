...
//    };
		this.palette = new int[ ] { this.color( 216, 129, 160 ), this.color( 243, 193, 120 ), this.color( 0, 163, 149 ),
				this.color( 254, 94, 65 ), this.color( 11, 5, 0 ) };
	...
	public void draw( ) {
		...
		float angle = (float) Math.atan2( this.nX[ pdx ], this.nY[ pdx ] );
		// Draw a rectangle longer in the length directional than it is wide in the
		// widthagonal directional
