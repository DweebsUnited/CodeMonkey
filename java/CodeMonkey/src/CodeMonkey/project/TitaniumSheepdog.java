...
public class TitaniumSheepdog extends PApplet {
	...
	private static String dataDir = TitaniumSheepdog.CM + "data/";
	...
	private void makeNormMap( ) {
		...
		this.normMap = this.createImage( this.TEX_WIDE, this.TEX_TALL, PConstants.RGB );
	...
	public void setup( ) {
		...
		this.colorMode( PConstants.HSB, 360, 100, 100, 100 );
	...
	public void keyPressed( ) {
		...
		if( this.key == 'w' ) {
			...
			this.canvas.save( TitaniumSheepdog.dataDir + "TitaniumSheepdog.png" );
		...
		// System.out.println( String.format( "Light: %f, %f, %f", this.light.x,
		// this.light.y, this.light.z ) );
		// } else if( this.key == 'h' ) {
