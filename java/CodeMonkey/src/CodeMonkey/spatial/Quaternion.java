...
public class Quaternion {
  ...
  public PVector mult( PVector v ) {
    float px = ( 1 - 2 * this.y * this.y - 2 * this.z * this.z ) * v.x + ( 2 * this.x * this.y - 2 * this.z * this.w ) * v.y + ( 2 * this.x * this.z + 2 * this.y * this.w ) * v.z;

    float py = ( 2 * this.x * this.y + 2 * this.z * this.w ) * v.x + ( 1 - 2 * this.x * this.x - 2 * this.z * this.z ) * v.y + ( 2 * this.y * this.z - 2 * this.x * this.w ) * v.z;

    float pz = ( 2 * this.x * this.z - 2 * this.y * this.w ) * v.x + ( 2 * this.y * this.z + 2 * this.x * this.w ) * v.y + ( 1 - 2 * this.x * this.x - 2 * this.y * this.y ) * v.z;
