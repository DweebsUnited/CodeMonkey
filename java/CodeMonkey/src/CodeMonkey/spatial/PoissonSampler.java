...
public class PoissonSampler {
  ...
  public PoissonSampler( float width, float height, float mDist, int nCount ) {
    ...
    this.grid = new Grid2D<PVector>( (int) Math.ceil( width / this.cellSize ), (int) Math.ceil( height / this.cellSize ) );
    ...
    PVector point = new PVector( PoissonSampler.rng.nextFloat( ) * this.width, PoissonSampler.rng.nextFloat( ) * this.height );
