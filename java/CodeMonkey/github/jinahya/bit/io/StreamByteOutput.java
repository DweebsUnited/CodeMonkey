...
public class StreamByteOutput< T extends OutputStream > extends AbstractByteOutput< T > {
	 ...
	 *
	 * @param target the output stream; {@code null} if it's supposed to be lazily
	 *               initialized and set.
	 */
	...
	/**
	 * {@inheritDoc} The {@code write(int)} method of {@code StreamByteOutput} class
	 * invokes {@link OutputStream#write(int)}, on what {@link #getTarget()} gives,
