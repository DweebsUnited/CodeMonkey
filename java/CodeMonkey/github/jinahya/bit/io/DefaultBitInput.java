...
/**
 * A default implementation of {@link ByteInput} which reads bytes from an
 * instance of {@link ByteInput}.
 *
...
public class DefaultBitInput< T extends ByteInput > extends AbstractBitInput {
	 ...
	 *                 {@code null} if it is intended to be lazily initialized and
	 *                 set.
	 */
	 ...
	 * invokes {@link ByteInput#read()} ,on what {@link #getDelegate()} gives, and
	 * returns the result. Override this method if the {@link #delegate} is supposed
