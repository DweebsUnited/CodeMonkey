...
public final class ByteInputs {
	...
	/**
	 * An implementation of {@link ByteInput} whose {@link ByteInput#read()} method
	 * always throws an {@link EOFException}.
	 */
	private static class NullByteInput implements ByteInput {

		/**
		 * {@inheritDoc} The {@code read} method of {@code NullByteInput} class always
		...
		public int read( ) throws IOException {
			...
			throw new EOFException( "an instance of " + this.getClass( ) );
		}
	}

	/**
	 * Returns a new {@link ByteInput} whose {@link ByteInput#read()} method always
	 * throws an {@link EOFException}.
	 *
