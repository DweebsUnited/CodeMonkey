...
public class DataByteOutput< T extends DataOutput > extends AbstractByteOutput< T > {
	 ...
	 *
	 * @param target the byte target; {@code null} if it is supposed to be lazily
	 *               initialized and set.
	 */
	...
	/**
	 * {@inheritDoc} The {@code write(int)} method of {@code DataByteOutput} class
	 * invokes {@link DataOutput#writeByte(int)}, on what {@link #getTarget()}
	 * gives, with specified {@code value}. Override this method if the
	...
	public void write( final int value ) throws IOException {
		...
		this.getTarget( ).writeByte( value );
	}
