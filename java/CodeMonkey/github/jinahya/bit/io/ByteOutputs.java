...
public final class ByteOutputs {
	...
	/**
	 * An implementation of {@link ByteOutput} whose {@link ByteOutput#write(int)}
	 * simply discard given value.
	 */
	private static final class NullByteOutput implements ByteOutput {

		/**
		 * {@inheritDoc} The {@code write} method of {@code NullByteOutput} class simply
		 * discards given value.
		 *
	...
	/**
	 * Returns a new {@link ByteOutput} whose {@link ByteOutput#write(int)} } method
	 * simply discards given value.
	 *
